...
>
  {[
    ...
    ['Recognition & Highlights', 'Certificate of Participation, Prize Money up to ₹25,000, Fastest Finger First Round, Hot Seat & Final Round Experience — a True KBC-Style Journey.'],
  ].map(([title, desc], i) => (
    <motion.div
      key={i}
      variants={{
...
<motion.h3
  ...
  className="
    inline-block
    text-slate-700 font-bold mb-3 tracking-wide
    px-4 py-2
    rounded-lg
    bg-yellow-100
